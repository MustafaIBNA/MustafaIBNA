...
I'm a Front-End Developer with a love for building **clean, interactive, and user-friendly** web experiences.  
When I'm not pushing pixels, I'm probably deep in a game — no regrets. 🎮

- 🔭 Currently crafting **React applications** that feel great to use
- 🌱 Always leveling up — exploring new tools, frameworks & best practices
- 👯 Open to **collaboration** — got a cool project idea? Let's talk!
- 💬 Happy to chat about **React, JavaScript, or web dev in general**
- 😄 Professional computer chair occupant *(it's a lifestyle)*
...
*"Write code like you're telling a story — make it worth reading."* ✨
